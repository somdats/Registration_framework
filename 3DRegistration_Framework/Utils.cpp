...
const float Constants<float>::zero = 0.0f;
const double Constants<double>::zero = 0.0f;

const float Constants<float>::one = 1.0f;
const double Constants<double>::one = 1.0f;
